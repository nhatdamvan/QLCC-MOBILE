...
import { ParticularTasks } from '../../screens';
...
function firstScreenStack({ navigation }) {
  ...
  return (
    <Stack.Navigator initialRouteName="ParticularTasks">
      <Stack.Screen
        name="ParticularTasks"
        component={ParticularTasks}
        options={{
          title: 'Tasks', headerShown: true,
          headerTitleStyle: {
            fontWeight: "700",
            fontSize: 20,
